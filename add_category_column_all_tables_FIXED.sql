-- Add Category Column to All Product Tables and Populate (FIXED VERSION)
-- Created: June 18, 2025
-- Fixed: fiber_optic_cable uses 'fiber_category' not 'fiber_type'
...
-- ============================================
-- Note: fiber_optic_cable already has a 'category' column with value 'FIBER OPTIC CABLE'
-- Let's update it to be more specific based on fiber_category
