-- Comprehensive inspection of all product tables (SAFE VERSION)
-- Shows columns and sample data for each table
-- NO DESTRUCTIVE OPERATIONS

-- Create a temporary inspection function (if it doesn't exist)
...
-- Note: The inspect_table_details function will remain in the database
-- You can manually drop it later with: DROP FUNCTION inspect_table_details(text);